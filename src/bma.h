...
//  ~BMA423();
//
//  bool begin(bma4_read_fptr_t readCallBlack, bma4_write_fptr_t writeCallBlack,
//             bma4_delay_us_fptr_t delayCallBlack,
...
//  bool getINT();
//  uint8_t getIRQMASK();
//  bool disableIRQ(uint16_t int_map = BMA456W_STEP_CNTR_INT);
//  bool enableIRQ(uint16_t int_map = BMA456W_STEP_CNTR_INT);
//  bool isStepCounter();
//  bool isDoubleClick();
//  bool isTilt();
//  bool isActivity();
...
//
//private:
//  bma4_read_fptr_t __readRegisterFptr;
//  bma4_write_fptr_t __writeRegisterFptr;
//  bma4_delay_us_fptr_t __delayCallBlackFptr;
//
//  uint8_t __address;
//  uint16_t __IRQ_MASK;
//  bool __init;
